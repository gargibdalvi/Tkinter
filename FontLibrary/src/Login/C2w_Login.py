...
class MainFrame():
    ...
    def __init__(self, parent, main_frame, userData):
        ...
        self.root.iconbitmap("C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\core2web.png")
        self.logIn()
    ...
    def logIn(self):
        ...
        self.bg_frame = Image.open('C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\background1.png')
        ...
        self.txt = "WELCOME"
        self.txt = "CORE2WEB"
        self.heading = tk.Label(self.lgn_frame, text=self.txt, font=('yu gothicui', 25, "bold"), bg="#040405",fg='white',bd=5,relief=tk.FLAT)
        self.heading.place(x=80, y=30, width=300, height=30)
      
        self.side_image = Image.open('C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\core2web.png')
        photo = ImageTk.PhotoImage(self.side_image)
        self.side_image_label = tk.Label(self.lgn_frame, image=photo,bg='#040405')
        self.side_image_label.image = photo
        self.side_image_label.place(x=5, y=100)
    
        self.sign_in_image = Image.open('C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\hyy.png')
        ...
        self.username_icon = Image.open('C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\username_icon.png')
        photo = ImageTk.PhotoImage(self.username_icon)
        self.username_icon_label = tk.Label(self.lgn_frame, image=photo,bg='#040405')
        self.username_icon_label.image = photo
        self.username_icon_label.place(x=550, y=332)

        self.lgn_button = Image.open('C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\btn1.png')
        photo = ImageTk.PhotoImage(self.lgn_button)
        self.lgn_button_label = tk.Label(self.lgn_frame, image=photo,bg='#040405')
        self.lgn_button_label.image = photo
        
        self.lgn_button_label.place(x=550, y=450)
        self.login = tk.Button(self.lgn_button_label, text='LOGIN', font=("yu gothic ui", 13, "bold"), width=25, bd=0,bg='#3047ff', cursor='hand2',
        activebackground='#3047ff', fg='white', command=self.switch_to_homeLabel)
        ...
        self.password_icon = Image.open('C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\password_icon.png')
        ...
        self.show_image = ImageTk.PhotoImage \
            (file='C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\show.png')
        self.hide_image = ImageTk.PhotoImage \
            (file='C:\\Users\\gargi\\OneDrive\\Documents\\Core2web\\Python Projects\\TKINTER\\FontLibrary\\assets\\images\\hide.png')
